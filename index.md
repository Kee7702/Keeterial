...
### Dropdowns
<div class="changelog-container closeable"><div style="margin-top:-8px"><i class="material-icons" style="margin-top: 8px;">build</i><h3 style="margin-top: 8px;">Dropdowns</h3><i class="material-icons" style="margin-top: 8px;"></i></div><div style="display: inherit;"><h4>Any elements can be in a dropdown. If javascript is disabled it will just appear as a section and everything will show. The icon can be anything from the material icons set, but cannot be removed as the script relies on it being there.</h4></div></div>
